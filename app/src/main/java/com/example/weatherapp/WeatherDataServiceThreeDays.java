...
public class WeatherDataServiceThreeDays {
    ...
    public WeatherDataServiceThreeDays(Context context){this.context = context;}
    ...
    public void getCityID(String cityName, WeatherDataServiceThreeDays.VolleyResponseListener volleyResponseListenerl) {
    ...
    public void getCityForecastByID(String cityID, WeatherDataServiceThreeDays.ForecastResponseListener forecastResponseListener) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i = 0; i < consolidated_weather_list.length() - 3; i++) {
                    ...
                    forecastResponseListener.onResponse(weatherReportModels);
    ...
    public void getCityByName(String cityName, WeatherDataServiceThreeDays.GetCityForecastByNameCallback getCityForecastByNameCallback) {
        getCityID(cityName, new WeatherDataServiceThreeDays.VolleyResponseListener() {
            @Override
            ...
            public void onResponse(String cityID) {
                getCityForecastByID(cityID, new WeatherDataServiceThreeDays.ForecastResponseListener() {
                    @Override
                    public void onError(String message) {
                        Toast.makeText(context, "Error!", Toast.LENGTH_SHORT).show();
                    }
